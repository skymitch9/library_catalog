...
// ⚠️ The chip vocabulary and the summary sentence are ONE vocabulary and live
// in one file — see `RungMedia`'s header for why it is not in this one.
import {
  GapMedia,
  Media,
  PHYSICAL,
