...
> `gabi-fixer-design.md` rows are new that day (the two design docs are design
> only, nothing built; the findings doc is measurement only, no code changed);
