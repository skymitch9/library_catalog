 ...
 * checkbox (owner ask, 2026-08-24: *"i want ... any book i own 2 of in physical,
 * even if different editions."*).
 *
 ...
 *
 * 1. ⚠️ **Two physical copies across DIFFERENT editions** — the case the owner
 *    named: a hardcover of one printing and a paperback of another are two copies.
 * 2. ⚠️ **A physical copy beside an ebook copy** counts as ONE physical.
 * 3. ⚠️ **A copy with no edition yet** is a physical object on the shelf.
 * 4. ⚠️ **`lent` counts, `wanted`/`sold`/etc. do not** — `HELD_STATUSES`.
 */
